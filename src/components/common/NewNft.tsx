...
const NewNft = ({
  ...
  return (
    <div className="p-1 transition-all border-2 rounded-lg hover:-translate-y-1 w-max group hover:shadow-2xl">
      <div className="relative max-w-sm overflow-hidden rounded-lg">
        ...
        />
        <div
          className="absolute top-0 bottom-0 left-0 right-0 w-full h-full overflow-hidden transition duration-300 ease-in-out opacity-0 bg-gradient-to-b from-black to-transparent hover:opacity-70"
          data-mdb-ripple="true"
          data-mdb-ripple-color="light"
        >
          <div className="m-3">
            <h3 className="mb-1 text-white">Description: </h3>
            <p className="font-bold text-gray-50">{description}</p>
          </div>
        </div>
      </div>
      <div className="m-2">
